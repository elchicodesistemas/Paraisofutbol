const CACHE='paraiso-pilot-v9';const ASSETS=['/','/app.js?v=9','/club.css','/pilot.css?v=9','/school.css?v=9','/escudo.png','/manifest.webmanifest','/icons/icon-192.png','/icons/icon-512.png'];
